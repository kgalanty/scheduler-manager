  ...
  <form action="">
                <div class="modal-card" style="width: auto">
                    ...
                    <section class="modal-card-body">
                       You are about to delete selected template. This won't affect shifts made from it before. It cannot be undone. Are you sure ?
...
export default {
  ...
  methods:
  {
    DelConfirm()
    {
      ...
      this.$http
            .post("./scheduleapi/templates/delete", {
              id: this.id,
            })
            .then((r) => {
